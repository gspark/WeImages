...
void WxCursor::recalculate(const QPoint &gMousePos, const QRect &frameRect)
{
...
WxBarPrivate::WxBarPrivate()
{
    ...
    m_normalRect = ShScreen::normalRect();
...
void WxBarPrivate::init()
{
    ...
    m_toolBar->setObjectName(QLatin1String("shrill_sys_toolbar"));
...
void WxBarPrivate::installWidget(QWidget *w)
{
    m_mainWidget = w;
...
void WxBarPrivate::setIconDark(bool dark)
{
...
void WxBarPrivate::handleWidgetMouseEvent(QObject *obj, QEvent *event)
{
    Q_UNUSED(obj);
    switch (event->type()) {
...
bool WxBarPrivate::windowTitleChange(QObject *obj)
{
...
bool WxBarPrivate::windowIconChange(QObject *obj)
{
    QWidget *pWidget = qobject_cast<QWidget *>(obj);
...
void WxBarPrivate::windowSizeChange(QObject *obj)
{
...
void WxBarPrivate::windowStateChange(QObject *obj)
{
    Q_UNUSED(obj);
...
void WxBarPrivate::updateWindowButtons()
{
...
void WxBarPrivate::handleMousePressEvent(QMouseEvent *event)
{
...
void WxBarPrivate::handleMouseReleaseEvent(QMouseEvent *event)
{
    if (event->button() == Qt::LeftButton) {
        m_bEdgePressed = false;
...
void WxBarPrivate::handleMouseMoveEvent(QMouseEvent *event)
{
    if (m_bEdgePressed) {
...
void WxBarPrivate::handleLeaveEvent(QEvent *event)
{
    Q_UNUSED(event);
    if (!m_bEdgePressed) {
...
void WxBarPrivate::handleHoverMoveEvent(QHoverEvent *event)
{
...
void WxBarPrivate::handleMouseDblClickEvent(QMouseEvent *event)
{
    if (event->button() == Qt::LeftButton) {
...
void WxBarPrivate::restoreWidget(QWidget *pWidget)
{
    m_isMaximized = false;
...
void WxBarPrivate::maximizeWidget(QWidget *pWidget)
{
    m_isMaximized = true;
...
void WxBarPrivate::resizeWidget(const QPoint &gMousePos)
{
    QRect origRect;
...
void WxBarPrivate::moveWidget(const QPoint &gMousePos)
{
    m_mainWidget->move(gMousePos - m_dragPos);
}

void WxBarPrivate::doubleMoveWidget()
{
...
void WxBarPrivate::updateCursorShape(const QPoint &gMousePos)
{
 ...
 *
 ******************************************************************************/
QPoint WxBarPrivate::calcDragPoint(QWidget *pWindow, QMouseEvent *event) const
{
...
QRect WxBarPrivate::validDragRect()
{
    ShScreen screen;
    QRect rect = screen.screenRect(m_currentScreen);
...
void WxBarPrivate::slotSysButtonClicked()
{
...
WxBar::WxBar(QWidget *parent)
    : QObject(parent), d(new WxBarPrivate())
{
    Q_ASSERT(parent);
...
QWidget *WxBar::mainWidget() const
{
    return d->m_mainWidget;
}

QLabel *WxBar::titleLabel() const
{
...
QWidget *WxBar::sysToolBar() const
{
    return d->m_toolBar;
}

void WxBar::addAction(QAction *action)
{
    d->m_toolBar->insertAction(d->m_minimizeAction, action);
}

void WxBar::setCloseIcon(QIcon &icon)
{
    d->m_closeAction->setIcon(icon);
}

void WxBar::setMaximizeIcon(QIcon &icon)
{
...
void WxBar::setMinimizeIcon(QIcon &icon)
{
    d->m_minimizeAction->setIcon(icon);
}

void WxBar::setNormalIcon(QIcon &icon)
{
    d->m_normalIcon = icon;
    if (!d->m_isMaximized) {
        d->m_maximizeAction->setIcon(icon);
...
void WxBar::setIconDark(bool dark)
{
    d->setIconDark(dark);
}

void WxBar::setWidgetResizable(bool resizable)
{
    d->m_bWidgetResizable = resizable;
}

void WxBar::setWidgetMovable(bool movable)
{
    d->m_bWidgetMovable = movable;
}

void WxBar::setWidgetMaximizable(bool maximizable)
{
    d->m_bWidgetMaximizable = maximizable;
}

void WxBar::updateWidgetFlags()
{
 ...
 */
void WxBar::setTitleBar(QWidget *widget)
{
    d->m_titleBar = widget;
}

bool WxBar::eventFilter(QObject *object, QEvent *event)
{
    switch (event->type()) {
